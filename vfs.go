...
//func (v *vfs) Item(ctx context.Context, path string) (file s3_wrappers.Item, err error) {
...
//func (v *vfs) List(ctx context.Context, prefix string, pageSize int) (files []s3_wrappers.Item, err error) {
//	err = v.Connect()
//	if err != nil {
...
//}
//
//func (v *vfs) getItem(file, bucket string) (item s3_wrappers.Item, err error) {
//	var urlPath url.URL
//
//	// если передан разделитель, то заменяем / на него (возможно понадобится для совместимости плоских хранилищ)
//	if v.comma != "" {
