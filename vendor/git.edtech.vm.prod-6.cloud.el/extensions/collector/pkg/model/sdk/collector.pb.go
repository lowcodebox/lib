...
func (x *ExecIn) GetMethod() string {
	if x != nil {
		return x.Method
	}
	return ""
...
func (x *ExecIn) GetParams() string {
	if x != nil {
		return x.Params
	}
	return ""
...
func (x *ExecOut) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_collector_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x09, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x22, 0x52, 0x0a, 0x06,
	0x45, 0x78, 0x65, 0x63, 0x49, 0x6e, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x22, 0x31, 0x0a, 0x07, 0x45, 0x78, 0x65, 0x63, 0x4f, 0x75, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x72,
	...
	0x02, 0x69, 0x64, 0x32, 0x3a, 0x0a, 0x09, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72,
	0x12, 0x2d, 0x0a, 0x04, 0x45, 0x78, 0x65, 0x63, 0x12, 0x11, 0x2e, 0x63, 0x6f, 0x6c, 0x6c, 0x65,
	0x63, 0x74, 0x6f, 0x72, 0x2e, 0x45, 0x78, 0x65, 0x63, 0x49, 0x6e, 0x1a, 0x12, 0x2e, 0x63, 0x6f,
	0x6c, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x2e, 0x45, 0x78, 0x65, 0x63, 0x4f, 0x75, 0x74, 0x42,
...
var file_collector_proto_goTypes = []interface{}{
	(*ExecIn)(nil),  // 0: collector.ExecIn
	(*ExecOut)(nil), // 1: collector.ExecOut
}
var file_collector_proto_depIdxs = []int32{
	0, // 0: collector.Collector.Exec:input_type -> collector.ExecIn
	1, // 1: collector.Collector.Exec:output_type -> collector.ExecOut
